						...
						children: [
							{ path: '', name: 'adminClassroomListPage', component: AdminClassroomListPage, meta: { index: '03' } },
							{
								...
								children: [
									...
									{ path: ':computerId(general|\\d+)', name: 'adminReportListPage', component: AdminReportListPage, meta: { index: '03' } }
								]
							},
						]
					},
						...
						children: [
							{ path: '', name: 'classroomListPage', component: ClassroomListPage, meta: { index: '2' } },
							{
								...
								children: [
									...
									{ path: ':computerId(general|\\d+)', name: 'reportListPage', component: ReportListPage, meta: { index: '2' } }
								]
							},
						]
					},
